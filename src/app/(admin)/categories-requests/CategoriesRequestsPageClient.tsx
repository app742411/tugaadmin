      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6 p-5 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xs">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs border border-gray-200 dark:border-gray-850 rounded-xl bg-gray-50/20 dark:bg-gray-950/20 text-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-brand-500 focus:border-brand-500 transition"
          />
        </div>
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-3.5 text-start">
                        <div className="flex items-center gap-3">
                          <div className={`w-9 h-9 rounded-full flex items-center justify-center font-bold text-xs ${avatarBg}`}>
                            {initials}
                          </div>
                      ...
                      <TableCell className="px-6 py-3.5 text-center">
                        <div className="relative inline-block text-left">
                          <button
                            ...
                            className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-200 dark:hover:bg-white/[0.05] transition-colors dropdown-toggle"
                          >
                            <MoreDotIcon />
                          </button>
                          <Dropdown
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col z-10 border-l border-gray-150 dark:border-gray-800">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50/50 dark:bg-gray-950/20 border border-gray-100 dark:border-gray-850">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm ${getAvatarBg(selectedRequest.traderProfile?.user?.fullName || "Trader")}`}>
