...
import { useGetPendingReviews } from "@/hooks/useReviews";
...
export default function ReviewsPageClient() {
  ...
  const { data, isLoading, error } = useGetPendingReviews(queryParams);
  ...
  const formatReviewStatus = (statusVal: string) => {
    switch (statusVal) {
  ...
  return (
    <div className="w-full pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <PageBreadcrumb pageTitle="Reviews Moderation" />
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 ml-0.5">
            View and moderates customer reviews across the platform.
          </p>
        </div>
        <div className="text-xs text-gray-455 dark:text-gray-500 font-semibold bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-850 px-3 py-1.5 rounded-lg flex items-center justify-center sm:self-end">
          Found {paginationInfo.total} pending review{paginationInfo.total === 1 ? "" : "s"}
        </div>
      </div>
          ...
          <div className="flex flex-col gap-1.5 lg:col-span-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search by customer, trader, or review title..."
            ...
            <Table className="w-full table-auto">
              <TableHeader className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-950/20">
                <TableRow>
                  <TableCell
                    isHeader
                    className="px-3 sm:px-4 py-3.5 font-bold text-gray-600 text-start text-xs uppercase tracking-wider dark:text-gray-400 whitespace-nowrap"
                  >
                    Customer
                  </TableCell>
                  <TableCell
                  ...
                  <TableCell
                    isHeader
                    className="px-2 sm:px-3 py-3.5 font-bold text-gray-600 text-center text-xs uppercase tracking-wider dark:text-gray-400 whitespace-nowrap"
                  >
                    Proofs
                  </TableCell>
                  <TableCell
                      ...
                      >
                        ...
                        <TableCell className="px-3 sm:px-4 py-3 text-start">
                          <div className="flex items-center gap-2.5">
                            {review.customer.profileImage ? (
                              ...
                              <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[11px] flex-shrink-0 ${custColor}`}
                              >
                                {custInit}
                              </div>
                            )}
                            <div className="flex flex-col min-w-0">
                              <span className="font-semibold text-gray-800 dark:text-white/90 text-xs sm:text-sm truncate">
                        ...
                        <TableCell className="px-3 sm:px-4 py-3 text-start">
                          <div className="flex items-center gap-2.5">
                            {review.trader.profileImage ? (
                              ...
                              <div
                                className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[11px] flex-shrink-0 ${tradColor}`}
                              >
                                {tradInit}
                              </div>
                            )}
                        ...
                        <TableCell className="px-3 sm:px-4 py-3 text-start">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="font-semibold text-gray-800 dark:text-white text-xs truncate max-w-[130px]">
                              {review.title}
                            </span>
                          </div>
                        </TableCell>
                        ...
                        {/* Review text */}
                        <TableCell className="px-3 sm:px-4 py-3 text-start text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-normal">
                          <p className="line-clamp-2 max-w-[180px] xl:max-w-[220px] break-words">
                            {review.review}
                          </p>
                        </TableCell>

                        {/* Proofs count */}
                        <TableCell className="px-2 sm:px-3 py-3 text-center">
                        ...
                        {/* Submitted Date */}
                        <TableCell className="px-3 sm:px-4 py-3 text-start text-gray-500 dark:text-gray-400 text-xs whitespace-nowrap">
                        ...
                        <TableCell className="px-2 sm:px-3 py-3 text-center" onClick={(e) => e.stopPropagation()}>
                          <div className="relative inline-block text-left">
                            ...
                            <Dropdown
                              ...
                              className={`w-44 absolute right-0 z-50 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-lg dark:shadow-none p-1.5 ${index >= 2 && index >= reviewsList.length - 2
                                ? "bottom-full mb-1.5"
                                : "top-full mt-1.5"
                                }`}
                            >
                              <div onClick={(e) => e.stopPropagation()} className="flex flex-col gap-1">
                                ...
                                <DropdownItem
                                  ...
                                  onItemClick={() => {
                                    setOpenDropdownId(null);
                                    handleOpenRejectModal(review.id);
                                  }}
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col z-10 border-l border-gray-100 dark:border-gray-800">
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-800 flex-shrink-0">
              <h3 className="text-base font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                <Badge color={getStatusColor(selectedReview.status)} size="sm">
                  {formatReviewStatus(selectedReview.status)}
                </Badge>
              </h3>
              <button
                onClick={() => setSelectedReview(null)}
