              ...
              {isLoading ? (
                ...
                quotesList.map((quote, index) => (
                  <TableRow
                    ...
                    className={`cursor-pointer hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors border-b border-gray-100 dark:border-gray-800/80 ${
                      openDropdownId === quote.id ? "relative z-30" : ""
                    }`}
                  >
                    {/* Job Title / ID */}
                      ...
                      <div className="relative inline-block text-left">
                        ...
                        <Dropdown
                          ...
                          className={`w-44 absolute right-0 z-50 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-lg dark:shadow-none p-1.5 ${
                            index >= 2 && index >= quotesList.length - 2
                              ? "bottom-full mb-1.5"
                              : "top-full mt-1.5"
                          }`}
                        >
