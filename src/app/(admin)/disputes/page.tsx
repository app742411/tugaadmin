  ...
  return (
    <div className="w-full pb-12">
      ...
      <div className="max-w-2xl mx-auto mt-10 text-center">
        ...
        <div className="relative w-28 h-28 mx-auto mb-8 flex items-center justify-center rounded-xl bg-amber-50 dark:bg-amber-950/15 border border-amber-100 dark:border-amber-900/30">
          <div className="absolute inset-0 rounded-xl bg-amber-500/10 blur-xl animate-pulse" />
          <svg
