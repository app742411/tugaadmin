  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 bg-white dark:bg-white/[0.03]">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 bg-gray-50/50 dark:bg-gray-950/20 px-4 py-3.5 rounded-2xl border border-gray-100 dark:border-gray-800 flex-shrink-0">
          <Switch
