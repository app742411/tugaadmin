...
export default function SignInForm() {
  ...
  return (
    <div className="flex flex-col flex-1 lg:w-1/2 w-full items-center justify-center p-6 sm:p-12">
      <div className="w-full max-w-[420px] bg-white rounded-[32px] sm:shadow-[0_8px_40px_rgb(0,0,0,0.04)] sm:p-10 border border-gray-100/50">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-14 bg-[#1B261F] hover:bg-[#121A15] text-white font-semibold rounded-2xl flex items-center justify-center gap-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed shadow-md"
            >
              {isLoading ? (
                <>
